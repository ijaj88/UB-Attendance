...
const FilteredSpaces = ({filters2}) => {

  const { attendanceType, ...filters } = filters2;
  ...
  const renderTooltip = (props) => (
    <BootStrapTooltip id="overlay-tooltip" {...props}>
      Drill Down of User Attendance Across Spaces based upon the filters selected in above Pie Distribution.
    </BootStrapTooltip>
  );
  ...
  return (
    <>
      <h4 style={{ textAlign: 'center' }}>Spaces your selected Pie Group is interested In</h4>
