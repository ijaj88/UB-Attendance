...
const AllEventChart = () => {
  ...
  const renderTooltip = (props) => (
    <BootStrapTooltip id="overlay-tooltip" {...props}>
      Count of Events Scheduled Across Time, useful when trying to identify the number of Events held on a Daily/Weekly.... basis
    </BootStrapTooltip>
  );

  return (
    <div style={{padding:'50px'}}>
      <h4 style={{textAlign:'center'}}>Event Creation Over Time</h4>
      <label>
          Distribute By:
